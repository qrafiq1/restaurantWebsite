...
timeButton.addEventListener('click', () => {
    ...
    fetch('https://20240102t191422-dot-restaurant-407220.uc.r.appspot.com/query', {
        method: 'POST',
        headers: {
...
submitButton.addEventListener('click', () => {
    ...
    fetch('https://20240102t191422-dot-restaurant-407220.uc.r.appspot.com/submitBooking', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        },
